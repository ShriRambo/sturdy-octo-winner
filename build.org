...
This works with some specific properties and not all custom property so the following hack."
  (concat "" (with-temp-buffer 
               (insert-file-contents (concat "./content/blog/" file) )
               (cdr
                (assoc "DESCRIPTION" 
	               (org-element-map
  ...
  (setq org-publish-project-alist
        (list
         (list "blog"
	           ...
	           :html-postamble t
               :description "This is a test description. Find me."
               :html-postamble-format (sa/get-template 'postamble)
	       )
	 (list "microblog"
               :recursive t
               :base-directory "./content/microblog"
               :base-extension "org"
               :publishing-function 'org-html-publish-to-html
               :publishing-directory "./public/microblog"
	 ...
	 (list "mail-site" :components '("microblog" "blog"))
	))
#+END_SRC
...
#+BEGIN_SRC shell :tangle no :result no
  #!/bin/bash

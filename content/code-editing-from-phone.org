...
There might be some good editors that works with webdav or sftp server. But I couldn't find any good ones for ios. My solution, run a code server and access it from anywhere with VPN. [[http://linuxserver.io][linuxserver.io]] has a nice docker image for this. It runs a selfhosted version of [[vscode.dev]]. 

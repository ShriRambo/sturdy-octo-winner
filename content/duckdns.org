...
DuckDNS ia a free Domain Name Service which can be setup to point any (available) subdomain of [[duckdns.org]] to an IP address or our choice. This is a dynamic DNS service, which means the IP address corresponding to your domain can easily be change. 
